	...
	<form class="container">
		<section >
			...
			<div  class="input">
				...
				<input  type="text" name="phone1" maxlength="4" autocomplete="off" class="small" value="010" readonly> <span  class="delimiter">-</span> <input id="phone2"  type="text" name="phone2" maxlength="4" autocomplete="off" class="small"> <span  class="delimiter">-</span> <input id="phone3"  type="text" name="phone3" maxlength="4" autocomplete="off" class="small">
			</div>
